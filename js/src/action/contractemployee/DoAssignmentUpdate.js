...
action.contractemployee.DoAssignmentUpdate = function(contract) {
	return new Ext.Action({
		id:      'action.contractemployee.doassignmentupdate',
		text:    'Update',
		iconCls: 'icon-assignment-edit',
		handler: function() {
			// Get the form panel.
			var formPanel = Ext.getCmp(
				'ui.panel.contractemployee.assignmentupdatepanel');

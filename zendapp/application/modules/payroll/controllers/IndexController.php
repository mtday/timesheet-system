...
class Payroll_IndexController extends BaseController
{
	/**
	...
	/**
	 * Go show the payroll home page for the specified pay period.
	 */
	function viewAction()
	{
		// Set the page title.
	...
	/**
	 * Retrieve the next pay period and go back to the payroll page.
	 */
	function nextAction()
	{
		// Set the page title.
